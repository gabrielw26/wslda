...
Presently the format support lattices in 1D, 2D, and 3D. Real, complex, and vector variables can be stored. To learn more, see [Documenation](./doc/README.md) in doc folder.

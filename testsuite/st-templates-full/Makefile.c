...
# COMPILER FLAGS
CFLAGS= -std=gnu99 -O3 -I/usr/local/elpa202005-openmpi311-gcc721-cuda90-lapack391/include/elpa-2020.05.001/ -DTESTSUITE -DREGULARIZATION_SCHEME=SPHERICAL_CUTOFF

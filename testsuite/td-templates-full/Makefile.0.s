...
CFLAGS= -std=gnu99 -O3 -I/usr/local/cuda-9.0/include/ \
        -DTARGET_MACHINE=DWARF -DTESTSUITE -DREGULARIZATION_SCHEME=SPHERICAL_CUTOFF
NVCCFLAGS = -arch sm_35 -O3 -std=c++03 -DTESTSUITE -DREGULARIZATION_SCHEME=SPHERICAL_CUTOFF

           ...
           double *params, size_t extra_data_size, void *extra_data)
{
    ...
    if(lineid==0) // HEADER
    {
        ...
        fprintf(log,"# 19: j[NX/2]\n");
        fprintf(log,"# 20: rho[NX/2]\n");
        fprintf(log,"# 21: j[NX/2]/vx\n");

        fprintf(log,"# 22: time per iteration (sec)\n");
        fprintf(log,"# 23: time & date of entry\n");
    }
    
    double j = h_densities.j_a_x[NX/2] + h_densities.j_b_x[NX/2];
    double rho=h_densities.rho_a[NX/2] + h_densities.rho_b[NX/2];
    double rho2=j/params[1];

    // add entry
    fprintf(log, "%6d %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %18.10g %10.2f %20s\n",
        it, // 1
        npart[SPINA], // 2
        npart[SPINB], // 3
        ...
        logger_get_time_from_last_entry(), //22
        buffer // 23
    );
    ...
    fprintf(fcmp,"npart     %20.10g\n", npart[SPINA]);
    fprintf(fcmp,"E_tot     %20.10g\n", E_tot);
    fprintf(fcmp,"rho       %20.10g\n", rho);
    fprintf(fcmp,"rho2      %20.10g\n", rho2);
    fclose(fcmp);

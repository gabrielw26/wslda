           ...
           double *params, size_t extra_data_size, void *extra_data)
{
    ...
    if(params[10]<0.5)
    {
        ...
        fprintf(fcmp,"energy[EKIN]     %20.10g %20.10g\n", observable[EKIN],eps);
        fprintf(fcmp,"energy[EPOT]     %20.10g %20.10g\n", observable[EPOT],eps);
        fprintf(fcmp,"energy[EPAIR]    %20.10g %20.10g\n", observable[EPAIR],eps);
        fprintf(fcmp,"energy[ECURRENT] %20.10g %20.10g\n", observable[ECURRENT],eps);
        fprintf(fcmp,"energy[EPOTEXT]  %20.10g %20.10g\n", observable[EPOTEXT],eps);
        fprintf(fcmp,"energy[EPAIREXT] %20.10g %20.10g\n", observable[EPAIREXT],eps);
        fprintf(fcmp,"energy[EVELEXT]  %20.10g %20.10g\n", observable[EVELEXT],eps);
    }
    else
    {
        // for testsuite

 ...
 * */
double u_ext(int ix, int iy, int it, int spin, double *params)
{
...
//     if(it<dc_params[5]) modify_potentials_imprint_ferron(it, h_densities, h_potentials, extra_data);
    ...
    modify_potentials_phase_imprint2(it, h_densities, h_potentials, (double *)extra_data);
 ...
 * */
double complex delta_ext(int ix, int iy, int it, double complex delta, double *params)
{
#ifdef UNIFORM_TEST_MODE
...
double vector_vext(int ix, int iy, int it, int spin, int coordinate, double *params)
{
#ifdef UNIFORM_TEST_MODE

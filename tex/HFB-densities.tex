...
\begin{eqnarray}
f_{\beta}(+E) \xrightarrow[\beta \to \infty]{} \frac{1}{e^{+E * \infty}+1} = 0, \\
f_{\beta}(-E) \xrightarrow[\beta \to \infty]{} \frac{1}{e^{-E * \infty}+1} = 1.
\label{eqn:distributions}
\end{eqnarray}
$f_{\beta}(+E)$ converges to $0$ from the positive numbers' side, resulting in 
\begin{equation}
    f_{\beta}(+E)\ln {f_{\beta}(+E)} \xrightarrow[f_{\beta}(+E) \to 0^+]{} 0.
\end{equation}

The equations of densities change to:
